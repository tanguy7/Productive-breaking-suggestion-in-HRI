...
label_1 =Label(root,text="I feel pleased", width=20,font=("bold",10))
...
label_2 =Label(root,text="I feel concerned", width=20,font=("bold",10))
...
label_3 =Label(root,text="I feel relaxed", width=20,font=("bold",10))
...
label_4 =Label(root,text="I feel tensed", width=20,font=("bold",10))
...
label_5 =Label(root,text="I feel tranquil", width=20,font=("bold",10))
...
label_6 =Label(root,text="I feel not confident", width=20,font=("bold",10))
...
root.mainloop()
results = ['Form3',var1.get(),var2.get(),var3.get(),var4.get(),var5.get(),var6.get()]
