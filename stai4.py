...
label_1 =Label(root,text="I feel untroubled", width=20,font=("bold",10))
...
label_2 =Label(root,text="I feel perturbed", width=20,font=("bold",10))
...
label_3 =Label(root,text="I feel happy", width=20,font=("bold",10))
...
label_4 =Label(root,text="I feel anxious", width=20,font=("bold",10))
...
label_5 =Label(root,text="I feel pleasantly good", width=20,font=("bold",10))
...
label_6 =Label(root,text="I feel self doubting", width=20,font=("bold",10))
...
root.mainloop()
results = ['Form4',var1.get(),var2.get(),var3.get(),var4.get(),var5.get(),var6.get()]
