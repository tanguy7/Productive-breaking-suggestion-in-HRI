...
label_1 =Label(root,text="I feel confuse", width=20,font=("bold",10))
...
label_2 =Label(root,text="I feel satisfied", width=20,font=("bold",10))
...
label_3 =Label(root,text="I am worried", width=20,font=("bold",10))
...
label_4 =Label(root,text="I feel at ease", width=20,font=("bold",10))
...
label_5 =Label(root,text="I feel calm", width=20,font=("bold",10))
...
label_6 =Label(root,text="I feel stressed out", width=20,font=("bold",10))
...
root.mainloop()
results = ['Form1',var1.get(),var2.get(),var3.get(),var4.get(),var5.get(),var6.get()]
